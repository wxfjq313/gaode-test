...
public class Polygon {
    ...
    /**
     * By given ray and one side of the polygon, test if both lines intersect.
     *
     * @param ray
     * @param side
    ...
    private boolean intersect(Line ray, Line side) {
        ...
        if (!ray.isVertical() && !side.isVertical()) {
            // test if both vectors are parallel. If they are parallel then no intersection point will exist
    ...
    private static class BoundingBox {
        public double xMax = Float.NEGATIVE_INFINITY;
        public double xMin = Float.NEGATIVE_INFINITY;
        public double yMax = Float.NEGATIVE_INFINITY;
        public double yMin = Float.NEGATIVE_INFINITY;
    }
}